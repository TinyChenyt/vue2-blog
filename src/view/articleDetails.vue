 ...
 * @LastEditTime: 2023-11-03 16:57:05
                ...
                <el-main>
                    ...
                    <div>
                        <!-- <mavon-editor v-model="article.content" ref="md" :subfield="false" defaultOpen="preview"
                            :editable="false" code-style="vs2015" :toolbarsFlag="false" navigation 
                            style="min-height: 800px; width: 95%; " /> -->
                        <!-- <v-md-editor v-model="article.content" height="800px"></v-md-editor> -->
                        <!-- <v-md-editor v-model="article.content" min-height="500px" left-toolbar="" :default-show-toc="true" @copy-code-success="handleCopyCodeSuccess" /> -->
